...
#Triangle varibles
tri_points = [Vector2(-100, screen_height), Vector2(0, screen_height), Vector2(-50, screen_height - 75)]
tri_origin_points = [Vector2(-100, screen_height), Vector2(0, screen_height), Vector2(-50, screen_height - 75)]
tri_color = [127,255,0]
tri_vec = Vector2(2, 0) #go to the right
...
while running:
    ...
    if circle_position.x >= screen_width - circle_redius or circle_position.x <= circle_redius:
        ...
        add_circles(circle_color, random_position(circle_redius), circle_redius)
    ...
    tri_points = [tri_points[0] + tri_vec, tri_points[1] + tri_vec, tri_points[2] + tri_vec] # move to right
    polygon(screen, tri_color, tri_points)

    # check if triangle off screen
    if tri_points[0][0] >= screen_width:
        tri_points = tri_origin_points
        tri_color = random_color()
